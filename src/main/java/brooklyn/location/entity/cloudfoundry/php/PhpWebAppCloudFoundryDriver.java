...
public class PhpWebAppCloudFoundryDriver implements PhpWebAppDriver {


    public static final Logger log = LoggerFactory.getLogger(PhpWebAppCloudFoundryDriver.class);
    ...
    PhpCloudFoundryWebAppImpl entity;
    private String applicationPath;
    private String applicationName;
    CloudFoundryClient client;

    public PhpWebAppCloudFoundryDriver(PhpCloudFoundryWebAppImpl entity, CloudFoundryPaasLocation location) {
    ...
    private void initApplicationParameters() {
        applicationName = getEntity().getConfig(PhpCloudFoundryWebApp.APPLICATION_NAME);
        applicationPath = getEntity().getConfig(PhpCloudFoundryWebApp.APPLICATION_PATH);
    }
    ...
    private void postLaunch() {
        ...
        entity.setAttribute(PhpCloudFoundryWebApp.ROOT_URL, domainUri);

        entity.setAttribute(PhpCloudFoundryWebApp.INSTANCES_NUM,
                application.getInstances());
        application.getResources();
        entity.setAttribute(PhpCloudFoundryWebApp.MEMORY,
                application.getMemory());

        entity.setAttribute(PhpCloudFoundryWebApp.DISK,
