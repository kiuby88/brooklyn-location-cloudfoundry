...
public class CloudFoundryYamlJMelody {
    ...
    private final String SERVICE_NAME = "test-brooklyn-service-mysql-JM";
    private final String SERVICE_TYPE_ID = "cleardb";
    private final String SERVICE_PLAN = "spark";

    private final String JDBC_SENSOR = "test-brooklyn-monitor-app-JM.credentials.jdbcUrl";
    private final String NAME_SENSOR = "test-brooklyn-monitor-app-JM.credentials.name";
    private final String HOSTNAME_SENSOR = "test-brooklyn-monitor-app-JM.credentials.hostname";
    private final String USERNAME_SENSOR = "test-brooklyn-monitor-app-JM.credentials.username";
    private final String PASSWORD_SENSOR = "test-brooklyn-monitor-app-JM.credentials.password";
    private final String PORT_SENSOR = "test-brooklyn-monitor-app-JM.credentials.port";
    ...
    public void deployWebappWithServicesFromYaml(){
        ...
        Application app = launcher.launchAppYaml("cf-webapp-db-jMelody.yaml").getApplication();
